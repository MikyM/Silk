...
public class ReminderServiceTests
{
    ...
    {
        // Arrange
        var mediatorMock    = new Mock<IInterjector>();
        ...
        // Assert
        mediatorMock.Verify(x => x.SendAsync(It.IsAny<GetAllReminders.Request>(), default), Times.Once);
    }
    ...
    public async Task CreatesReminderSuccessfully()
    {
        ...
        mediatorMock.Setup(m => m.SendAsync(It.IsAny<CreateReminder.Request>(), default))
        ...
        // Assert
        mediatorMock.Verify(x => x.SendAsync(It.IsAny<CreateReminder.Request>(), default), Times.Once);
    }
    ...
    public async Task CreatesDMMessageWhenMessageIDIsZero()
    {
        ...
        mediatorMock.Setup(m => m.SendAsync(It.IsAny<IRequest<IEnumerable<ReminderEntity>>>(), default))
                    .ReturnsAsync(() => new[]
                     {
                         new ReminderEntity
                             { OwnerID = new(69) }
    ...
    public async Task DispatchesExpiredRemindersImmediately()
    {
        ...
        mediatorMock.Verify(x => x.SendAsync(It.IsAny<RemoveReminder.Request>(), default), Times.Once);
    }
